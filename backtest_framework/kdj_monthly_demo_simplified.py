...
def main():
    ...
    try:
        ...
        # 6. Demonstrate Dynamic Indicator System (NEW FEATURE)
        ...
        for indicator in debug_info['computed_indicators']:
        ...
        print(f"📋 All Registered Indicators: {debug_info['registered_indicators']}")
